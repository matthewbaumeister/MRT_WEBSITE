...
export default function MatrixChat({
  ...
  const [webSearch, setWebSearch] = useState(false); // Disabled - web enrichment removed
  const [research, setResearch] = useState(false); // Disabled - does nothing
  ...
  // Removed resume button - reports run start to finish
  ...
  // Removed cleanup - reports continue running even if tab is closed
  // Reports will complete in the background
